...
class Lien extends EventEmitter {
    constructor (options) {
        ...
        this.staticRouter = express.Router();
        ...
        if (options.session) {
            ...
            if (typeof options.session.store === "string") {
                try {
                    ...
                    if (this.SessionStoreModule.__esModule && this.SessionStoreModule.default) {
                        this.SessionStoreModule = this.SessionStoreModule.default;
                    }
                } catch (e) {
    ...
    add (url, method, cb) {
        ...
        this.router[method].call(this.router, url, (req, res, next) => {
            let lien = new LienObj(req, res, next, this);
            cb(lien)
        })
    }
